...
function createPair({
  ...
  return {
    ...
    verify: (message, signature) => {
      return (0, _utilCrypto.signatureVerify)(message, signature, TYPE_ADDRESS[type](publicKey)).isValid;
    },
    ...
    vrfVerify: (message, vrfResult, context, extra) => {
      return type === 'sr25519' ? (0, _utilCrypto.schnorrkelVrfVerify)(message, vrfResult, publicKey, context, extra) : (0, _utilCrypto.signatureVerify)(message, (0, _util.u8aConcat)(TYPE_PREFIX[type], vrfResult.subarray(32)), TYPE_ADDRESS[type](publicKey)).isValid && (0, _util.u8aEq)(vrfResult.subarray(0, 32), vrfHash(vrfResult.subarray(32), context, extra));
    }
  };
}